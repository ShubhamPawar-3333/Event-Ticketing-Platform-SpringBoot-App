...
import com.shubhamP.Portfolio.eventTicketingApplication.exceptions.EventUpdateException;
import com.shubhamP.Portfolio.eventTicketingApplication.exceptions.TicketTypeNotFoundException;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorDto> handleMethodArgumentNotValidException(
        ...
        String errorMessage = fieldErrors.stream().findFirst().map(fieldError ->
